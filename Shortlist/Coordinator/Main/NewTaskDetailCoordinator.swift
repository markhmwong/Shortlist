...
class NewTaskDetailCoordinator: NSObject, Coordinator {
...
//	}
//
//	func showRedact(viewModel: TaskCreationViewModel) {
//		let vc = TaskCreationRedactViewController(viewModel: viewModel, coordinator: self)
//		guard let newTaskNavController = newTaskNavController else { return }
//		vc.title = "Redact"
//		newTaskNavController.pushViewController(vc, animated: true)
//	}
