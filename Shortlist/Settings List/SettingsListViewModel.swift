...
class SettingsListViewModel: NSObject, MFMailComposeViewControllerDelegate {
	...
	private func prepareDataSource() -> [SettingsListItem] {
		...
		let twitterItem = SettingsListItem(title: "Visit me on Twitter", subtitle: "Updates @markhmwong", section: SettingsListSection.support, icon: "at.circle.fill", item: .twitter)
